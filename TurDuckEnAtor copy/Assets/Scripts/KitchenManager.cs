...
public class KitchenManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // LARISSA - addded "coopText = coopGameObject.GetComponent<TextMeshProUGUI>();"
    ...
    void Update()
    {
        ...
        switch(chefState)
        {
            ...
            case CurrentOperation.BoneChicken:
                ...
                break;
            // LARISSA -- added "currentDuck = duckPond.RemoveDuck();"
            ...
            case CurrentOperation.BoneTurkey:
                // I think I removed a line here
                // LARISSA - added " currentTurkey.Debone();"
        ...
        if (!duckPond.NoMoreDucks())
        {
            foreach (int weight in duckPond.GetRemainingDuckWeights())
            {
                ...
                // I think I removed a line here
                // LARISSA - added "pondText.text += weight.ToString() + " ";"
            }
        }
        else
        {
        ...
        {
            // I think I removed a line here
            // LARISSA - added "foreach (int weight in chickenCoop.GetRemainingChickenWeights())"
            {
